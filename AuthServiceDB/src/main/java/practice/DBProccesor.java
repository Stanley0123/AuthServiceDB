...
public class DBProccesor {
    ...
    public static boolean check(String loginParam, String passwordParam)  {
        try{
    ...
    public static void insert(String loginParam, String passwordParam) throws PSQLException {
        try{
            Class.forName("org.postgresql.Driver");
